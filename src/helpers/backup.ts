...
export const backupTrips: Trip[] = [
    ...
    },
    {
        ...
        "long_description": "Hidden within the Paria Canyon–Vermilion Cliffs Wilderness, The Wave is a geological masterpiece of undulating sandstone. Its surreal patterns and vivid stripes draw photographers from around the world — though only a handful of daily visitors are permitted.",
        "rating": 5
    }
]
